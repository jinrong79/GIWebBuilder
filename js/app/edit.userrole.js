class editUserRole extends editBase{
    ...
    parseParam(params){
        ...
        this.addFormXMLUrl="settings/form_userrole_add.xml";
        this.editFormXMLUrl="settings/form_userrole_edit.xml";
    ...
    viewAdd(params){
        ...
        if(!params.success){
            params.success=function(e){
                j79.mwInform("mwOK","成功","添加用户角色分配成功！点击回到列表...", function () {
                    document.location.href=j79App.naviURL.userrole;
                });
            }
        }
    ...
    viewEdit(params) {
        ...
        if (!params.success) {
            params.success = function (e) {
                j79.mwInform("mwOK", "成功", "修改用户角色分配成功！点击回到列表...", function () {
                    document.location.href = j79App.naviURL.userrole;
                });
            }
        }
